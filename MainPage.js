...
, {           
        ...
        <Image  style={styles.IconApp}  source={require('./image/app_icon/training.png')} />
...
, {           
        ...
        <View style={styles.BoxApp}>
        <Image  style={styles.IconApp}  source={require('./image/app_icon/km.png')} />
        <Text style={styles.TitleApp}>KM</Text>
        </View>
    </TouchableHighlight>

        <View style={styles.BoxApp}>
        <Image   style={styles.IconApp}   source={require('./image/app_icon/welfare.png')} />
        <Text style={styles.TitleApp}>Welfare</Text>
        </View>
  </View>
  <View style={styles.ContainerBoxApp}>
  <View style={styles.BoxApp}>
        <Image   style={styles.IconApp}  source={require('./image/app_icon/csr.png')} />
        <Text style={styles.TitleApp}>CSR</Text>
        </View>
        <View style={styles.BoxApp}>
        <Image   style={styles.IconApp}   source={require('./image/app_icon/hr.png')} />
        <Text style={styles.TitleApp}>HR</Text>
        </View>
        <View style={styles.BoxApp}>
        <Image   style={styles.IconApp}   source={require('./image/app_icon/pr.png')} />
